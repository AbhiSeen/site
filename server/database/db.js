...
const Connection = async (username, password) => {
    const URL = `mongodb+srv://${username}:${password}@cluster0.whvld.mongodb.net/?retryWrites=true&w=majority`
    try {
...
client.on("connect", () => {client.flushdb();console.log("connection successful")});
