  ...
  return (
    <>
        ...
        <div className="aboutUstext">
            {/* <span className="text-indigo-700 text-2xl font-bold ">About Us</span> */}
            <h2 className="font-bold text-3xl mt-4 mb-0 sm:text-4xl colorBlack">About <span className="text-indigo-600 font-bold">AMFashion</span></h2>
            <div className='about-underline'></div>
            <p className="text-black-700 w-9/12">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid, 
